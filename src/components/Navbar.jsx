  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7x1 mx-auto">
        ...
        > 
          <img src={logo} alt="logo_Ozy" className="w-9 h-9 object-contain" />
            <p className='text-white text-[18px] font-bold cursor-pointer flex'>Osama&nbsp;<span className='sm:block hidden'>| JS Developer</span></p>
        </Link>
        ...
        <div className="sm:hidden flex flex-1 justify-end items-center">
          ...
          <div className={`${!toggle ? 'hidden' : 'false' } p-6 black-gradient absolute top-20 right-0 mx-4 my-2 min-w-[140px] z-10 rounded-xl`}>
